...
import { ListItem, ListItemText, ListItemIcon, IconButton, Divider, Card, CardContent, Box } from "@suid/material";
...
async function updateFavorite(article: Article, favorite: Accessor<boolean>, setFavorite: Setter<boolean>) {
        ...
        <ListItem>
            <Box sx={{
                ...
                <div style="grid-area: love; justify-self: end">
                    <ListItemIcon>
                        <IconButton onClick={() => updateFavorite(article, favorite, setFavorite)}>
